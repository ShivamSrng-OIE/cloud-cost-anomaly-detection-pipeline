...
| 11 | Cascade clustering | For each account, clusters ensemble-flagged anomalies using DBSCAN on a combined feature space of scaled date and one-hot-encoded service. Clusters containing anomalous rows from two or more distinct services are labelled as predicted cascades. |
